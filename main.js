(function ($) {
	...
	class Silence {
        ...
        profile: {
            enable: true,
            avatar: 'https://raw.githubusercontent.com/zsy35689c/kuuuu/main/20260420214803783.jpg',
            favicon: 'https://raw.githubusercontent.com/zsy35689c/kuuuu/main/20260420220345086.jpg',
        },
        catalog: {
            enable: true,
            move: true,
        ...
        signature: {
            enable: true,
            home: 'https://www.cnblogs.com/muciblog/',
            license: 'CC BY 4.0',
        ...
        sponsor: {
            enable: true,
            paypal: null,
            wechat: 'https://raw.githubusercontent.com/zsy35689c/kuuuu/main/20260420215043268.png',
            alipay: 'https://raw.githubusercontent.com/zsy35689c/kuuuu/main/20260420215208797.jpg'
        },
        github: {
            enable: false,
            color: '#fff',
            fill: '#FF85B8',
            link: 'https://github.com/zsy35689c'
        },
	topImg: {
  	homeTopImg: [
...
"https://img2018.cnblogs.com/blog/1646268/201908/1646268-20190808213858652-132088076.jpg"
  ...
  topInfo: {
				title: 'Hi,Ms.Ya',
                text: '陪自己长大是一件很酷的事！.',
				github: "https://github.com/zsy35689c/",
				music: "",
				twitter: "",
				zhihu:"",
				mail: "",
		...
		buildCustomElements() {
			...
			$("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/muciblog/p/your-friends.html">友链</a><i></i></li><li><a id="blog_nav_myzanshang" class="menu" href="https://www.cnblogs.com/muciblog/p/your-donate.html">赞赏</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="https://www.cnblogs.com/muciblog/p/about.html">关于</a><i></i></li>');
			...
			let guanyu = '<ul class="sub-menu">' +
    			'<li><a href="https://www.cnblogs.com/muciblog/p/about.html"><i class="fa fa-user" aria-hidden="true"></i> 关于我</a></li>' +
    			'<li><a href="https://www.cnblogs.com/muciblog/p/archive.html"><i class="fa fa-book" aria-hidden="true"></i> 归档</a></li>' +
    			'</ul>';
		...
		for(let i = article_list.length-1;i>=0;i--)
		{
			...
			for(let j=PostTitles.length-1;j>=0;j--)
			{
				...
				`     <div class="post-meta"> <span><i class="iconfont icon-attention"></i>${readNum} 热度</span> <span class="comments-number"><i class="iconfont icon-mark"></i>${comNum} 条评论</span> <span><i class="iconfont icon-cc-user"></i><a href="https://www.cnblogs.com/muciblog"></a>${author}</span></div>` +
		...
		postHeader() {
			...
			if (window.location.href.indexOf('articles') === -1) {
				var header =
    				`<p class="entry-census"><span><a href="https://www.cnblogs.com/muciblog/"><img src="https://raw.githubusercontent.com/zsy35689c/kuuuu/main/20260420214803783.jpg"></a></span><span><a href="https://www.cnblogs.com/muciblog/">Ms.Ya</a></span><span class="bull">·</span>${post_date}<span class="bull">·</span>${post_view_count} 次阅读</p>`;
